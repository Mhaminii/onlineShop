                ...
                <div className="container container-fluid">
                    <div className="row wrapper">
                        ...
                        <form className="shadow-lg" onSubmit={submitHandler} encType="multipart/form-data">
                            <h5 className="mb-4 text-center">ثبت نام</h5>
                            ...
                            {/* <div className="form-group">
                            <label htmlFor="password_field"> تکرار رمزعبور</label>
                            <input
                                type="password"
                                id="password_field"
                                className="form-control"
                            ...
                            <div className="form-group">
                                    <Link to="/login" className="float-right mt-3">قبلا ثبت نام کردید ؟ ورود </Link>
                                </div>
                        </form>
                        </div>
                    </div>
